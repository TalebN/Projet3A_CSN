                        ...
                        <input class="text_color" type="number" min="0" name="quantity" placeholder="Write a quantity" required="" value="{{$product->quantity}}">
                            ...
                            <div class="div_design">
                                ...
                                <select class="text_color" name="category" required="" >
                                    ...
                                    <option value="{{$category->categor_name}}">{{$category->categor_name}}</option>
                                    @endforeach
                                ...
                                <div class="div_design">
                                    ...
                                    <div class="div_design">
                                        ...
                                        <input style="background-color: blue;" type="submit" value="Update Product" class="btn btn-primary">
